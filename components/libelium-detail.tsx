...
export function LibeliumDetail() {
  ...
  const metrics = [
    ...
    },
    {
      ...
      description: 'Следете листната влага, температурата на листната повърхност и промените в диаметъра на стълба или плодовете. Това помага да разпознаете по-рано воден стрес, риск от измръзване и неблагоприятни условия за развитие.',
      icon: Leaf,
    },
  ]
